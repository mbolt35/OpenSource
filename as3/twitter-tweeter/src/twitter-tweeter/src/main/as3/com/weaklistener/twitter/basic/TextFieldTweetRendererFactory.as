...
package com.weaklistener.twitter.basic {
     ...
     * TextFieldTweetRenderer</code> objects.
     *
     * @author Matt Bolt
     */
    public class TextFieldTweetRendererFactory implements ITweetRendererFactory {
        ...
        /**
         * <code>TextFieldTweetRendererFactory</code> Constructor.
         */
        public function TextFieldTweetRendererFactory() {
            // Empty
        }
        ...
        public function tweetRenderer():ITweetRenderer {
            return new TextFieldTweetRenderer();
        }
