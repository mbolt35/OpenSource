...
package com.weaklistener.twitter.basic {
    ...
    /**
     * This function returns a renderer factory that generates
     * text field renderers.
     * 
     * @author Matt Bolt
     */
    public function textFieldRenderer():ITweetRendererFactory {
        return new TextFieldTweetRendererFactory();
    }
