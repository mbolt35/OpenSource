...
package com.weaklistener.twitter.basic {
    ...
    /**
     * This function returns the default tweet controller factory for Twitter
     * Tweeter.
     * 
     * @author Matt Bolt
     */
    public function defaultController():ITweetControllerFactory {
        return new DefaultTweetControllerFactory();
    }
